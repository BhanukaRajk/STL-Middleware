                ...
                <div className="w-full lg:w-5/12 border border-black-2 rounded-lg shadow-lg">
                    <form className="p-5">
                        ...
                        <div className="mb-4">
                            ...
                            <input type="password" id="password" className="text-gray-900 text-sm border-2 rounded-lg border-gray-400 focus:border-sky-900 outline-none w-full p-2.5" placeholder="•••••••••" required></input>
                        </div>
                        <div className="mb-4">
                            <label htmlFor="password" className="block mb-2 text-sm font-medium text-gray-900 ">Re Enter New Password</label>
                            <input type="password" id="password" className="text-gray-900 text-sm border-2 rounded-lg border-gray-400 focus:border-sky-900 outline-none w-full p-2.5" placeholder="•••••••••" required></input>
                        </div>
