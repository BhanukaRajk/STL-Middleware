                ...
                <div className="w-full lg:w-5/12 border border-black-2 rounded-lg shadow-lg">
                    <form className="p-5">
                        ...
                        <div className="mb-4">
                            ...
                            <input type="number" id="phone-number" className="text-gray-900 text-sm border-2 rounded-lg border-gray-400 focus:border-sky-900 outline-none w-full p-2.5" placeholder="071-xxxxxxx" required></input>
                        </div>
