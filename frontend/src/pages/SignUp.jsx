                    ...
                    <form className="p-5">
                        ...
                        <div className="grid grid-cols-2 gap-x-4 mb-4">
                            <div>
                                ...
                                <input type="text" id="first-name" className="text-gray-900 text-sm border-2 rounded-lg border-gray-400 focus:border-sky-900 outline-none w-full p-2.5" placeholder="First Name" required></input>
                            </div>
                            <div>
                                <label htmlFor="last-name" className="block mb-2 text-sm font-medium text-gray-900">Last name</label>
                                <input type="text" id="last-name" className="text-gray-900 text-sm border-2 rounded-lg border-gray-400 focus:border-sky-900 outline-none block w-full p-2.5" placeholder="Last Name" required></input>
                            </div>

                        </div>
                        <div className="mb-4">
                            <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900">Email</label>
                            <input type="email" id="email" className="text-gray-900 text-sm border-2 rounded-lg border-gray-400 focus:border-sky-900 outline-none block w-full p-2.5" placeholder="john.doe@company.com" required></input>
                        </div>
                        <div className=" grid grid-cols-2 gap-x-4 mb-4">
                            <div>
                        ...
                        <div>
                            <p><span onClick={() => navigate('/login')} className='font-bold px-1 cursor-pointer'>Sign In</span>Here</p>
                        </div>
